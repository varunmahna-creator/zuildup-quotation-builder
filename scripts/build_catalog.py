...
OVERRIDES = {
    ...
    "bathroom.cpvc_fittings":   { "brands": ["Astral", "Supreme"] },
    ...
    "kitchen.cpvc_fittings":    { "brands": ["Astral", "Supreme"] },
    "kitchen.modular_kitchen":  { "brands": ["Ozone"] },  # soft-close hardware
    ...
    "electrical.switch_sockets":                 { "brands": ["Havells", "Anchor"] },
    ...
    for ti, (cat_key, cat_label, scope) in CATEGORY_FROM_TABLE.items():
        ...
        for ri in range(1, len(rows)):
            ...
            item = {
                ...
                "brands": brands,
                "scope": scope,
                "description": desc.strip() or first.strip(),
            }
